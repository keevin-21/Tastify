...
export const LessonButton = ({
    ...
    const rigthPos = indentationLevel * 40
    ...
    const href = isCompleted || current ? `/lesson/${id}/context` : "/lesson";
            ...
            >
                {current ? (
                    <div className="h-[102px] w-[102px] relative">
                        <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-[#FF6F1F] bg-white rounded-xl animate-bounce tracking-wide z-10">
                            Start
                            <div
